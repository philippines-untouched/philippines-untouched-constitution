...
**Purpose:** This log records significant authoring decisions and their reasons, so that future generations can understand not only what the Constitution says, but why it took its present form. Every entry preserves the reasoning, the alternative considered, and the decision.

---

## Entry 001 — Provenance of Authoring Context

- **Date:** At authoring foundation establishment
- **Decision:** The reasoning behind this Constitution — the authoring brief, planning notes and private deliberations — is preserved as a private institutional record in the Philippines Untouched farm repository (private). This public repository holds the Constitution and its authoring framework only.
- **Reason:** The Constitution is public because the Company is accountable to the principles it publishes. The planning deliberations are private because they contain personal and strategic material not intended for public consumption. Both records are versioned institutional memory; neither is lost.
- **Alternatives considered:**
  1. Publishing the authoring brief in this public repository — rejected: would expose private planning material and contradict the principle that the Constitution is not about any individual.
  2. Keeping the reasoning only in personal notes — rejected: not versioned, not institutional, at risk of loss.
- **Status:** Ratified by the authoring foundation.

---

## Entry 002 — Choice of Public License

- **Date:** At authoring foundation establishment
- **Decision:** The Constitution is licensed under **Creative Commons Attribution-NoDerivatives 4.0 International (CC BY-ND 4.0)**.
- **Reason:** The Company is accountable to the principles it publishes and the Constitution is intended to be freely readable and shareable by anyone — customers, partners, certification bodies, regulators, the public. CC BY-ND 4.0 permits unlimited sharing and redistribution (including commercial use) with attribution, while prohibiting third parties from publishing altered or derivative versions. This protects the integrity of the constitutional text: the public must always be able to read what the Company actually committed to, not a modified version. The "NoDerivatives" term is consistent with the authoring principle that the Constitution evolves only by formal amendment, never by silent change.
- **Alternatives considered:**
  1. **CC BY 4.0** (attribution only, derivatives allowed) — rejected: would permit third parties to publish modified versions, undermining the principle that only the Company's formal amendment process may change the Constitution.
  2. **CC0 1.0** (public domain dedication) — rejected: would waive all rights and attribution, inconsistent with the institutional authorship principle.
  3. **All rights reserved** — rejected: contrary to the public transparency principle; the Constitution should be freely readable and shareable, not restricted.
  4. **No license** — rejected: would create legal uncertainty; third parties would have no clear permissions.
- **Status:** Ratified by the authoring foundation.
...
## Entry 009 — Ratification of Chapter 3 (Mission)

- **Date:** At authoring foundation establishment
- **Decision:** Chapter 3 — Mission (`constitution/03-mission.md`) is ratified as the third substantive chapter of the Constitution, Version 1.0.
- **Reason:** The chapter defines what the Company does every day to achieve its Vision, converting the Company's enduring principles into consistent daily action. It draws the Company's activities from §8 (Core Business) of the authoring brief — cultivation, harvesting, processing, manufacturing, packaging, quality assurance, branding, distribution, sales, product development and innovation — while retaining the flexibility to evolve that the brief requires. The chapter passed the Definition of Done and the Future Leader Test. It reinforces the integrated-system principle (brief §4) and frames the Mission's principles as constant while its activities evolve, consistent with Constancy of Purpose.
- **Alternatives considered:**
  1. Listing the Company's activities as a fixed catalogue — rejected: the brief explicitly states the product lineup and activities should remain intentionally broad in the constitutional document; principles, not catalogues.
  2. Merging Mission into the Vision chapter — rejected: Vision (what we seek to become) and Mission (what we do) are distinct questions; the TOC separates them deliberately.
- **Status:** Ratified by the authoring foundation.
...
## Entry 025 — Ratification of Chapter 20 (Long-Term Strategy)

- **Date:** At authoring foundation establishment
- **Decision:** Chapter 20 — Long-Term Strategy (`constitution/20-long-term-strategy.md`) is ratified as the nineteenth substantive chapter of the Constitution, Version 1.0, and the first chapter of Part IV (Strategy).
- **Reason:** The chapter defines the Company's long-term direction, measured in decades rather than years. It adopts the constitutional language proposed in §14 of the authoring brief — that the principles of the Company remain constant while its strategies, technologies and operations evolve — and frames long-term strategy as an expression of stewardship. The chapter passed the Definition of Done and the Future Leader Test. As the first chapter of Part IV, it establishes the principle that strategy serves purpose and never departs from the Founding Principles, upon which the remaining Strategy chapters build.
- **Alternatives considered:**
  1. Including specific strategic targets or plans — rejected: the Constitution is principle-based; specific strategies belong in subordinate Strategic Plans per the document hierarchy.
  2. Placing Strategy before Philosophy or Governance — rejected: the TOC order is deliberate; strategy (Part IV) must be grounded in the Company's beliefs (Part II) and governance (Part III).
- **Status:** Ratified by the authoring foundation.
...
## Entry 040 — Ratification of Chapter 35 (Corporate Reputation)

- **Date:** At authoring foundation establishment
- **Decision:** Chapter 35 — Corporate Reputation (`constitution/35-corporate-reputation.md`) is ratified as the thirty-fourth substantive chapter of the Constitution, Version 1.0, and the first chapter of Part VII (Brand).
- **Reason:** The chapter defines reputation as one of the Company's most valuable long-term assets. It passed the Definition of Done and the Future Leader Test. The chapter expresses Founding Principles 10 (Earn Trust Every Day) and 5 (Build for Generations), framing reputation as earned through conduct rather than claimed through words, and as an inheritance each generation protects and strengthens. As the first chapter of Part VII, it establishes the value that the Brand chapters (Brand Architecture, Customer Trust) build upon.
- **Alternatives considered:**
  1. Treating reputation as a marketing or public-relations concern — rejected: reputation is a strategic asset earned through the Company's conduct; the chapter establishes it as such.
  2. Placing reputation in the Quality part — rejected: reputation is the accumulated judgement of the Company's conduct, which belongs in the Brand part; the TOC places it at the head of Part VII deliberately.
- **Status:** Ratified by the authoring foundation.
